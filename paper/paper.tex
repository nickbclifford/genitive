...
only in pronouns. Every pronoun in English has three different forms representing
...
has a fully functioning grammatical case system applying for all nouns
...
changes depends on the ending, case, and number of the noun.

Table 1 shows the different endings of the Russian nominative and
genitive cases in the singular and plural.

\begin{table}[t!]
\begin{center}
\begin{tabular}{|l|l|l}
\hline & \textbf{Singular} & \textbf{Plural} \\ \hline
\textbf{Nominative} & -a, -ja, -ija & -y, -i, -ii \\
\textbf{Genitive} & -y, -i, -ii & $\varnothing$, -', -ij \\ \hline
\textbf{Nominative} & $\varnothing$, -'/j, -ij & -y, -i, -ii, -je \\
...
\end{tabular}
\end{center}
\caption{\label{declension} Nominative and genitive endings for nouns with different endings. Note that the apostrophe ' is a palatalization character, corresponding to \foreignlanguage{russian}{ь} in Cyrillic. }
\end{table}
